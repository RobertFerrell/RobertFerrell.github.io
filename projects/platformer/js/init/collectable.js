(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.grace, 400, 180, 9, 0.6);
        collectable.create(type.grace, 200, 520);
        collectable.create(type.db, 250, 100, 20, 1);
        collectable.create(type.max, 700, 200, 50, .5)
